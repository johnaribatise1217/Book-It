          ...
          <div id="booking_invoice" className="px-4 border border-secondary">
            <header className="clearfix">
              ...
              <div id="project">
                ...
                <div><span>DATE</span> {new Date(booking?.createdAt).toLocaleDateString('en-US')}</div>
              ...
              <table className="mt-5">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="unit">{new Date(booking?.checkInDate).toLocaleDateString('en-US')}</td>
                    <td className="qty">{new Date(booking?.checkInDate).toLocaleDateString('en-US')}</td>
